...
//   2. Where it belongs: Tags (flyout); Move to folder…; Open in new split (membership and location, which
//      the kernel and the file system know about; the split item sits here until the drag lands)
...
const MARKERS: Record<string, string> = {
  ...
  split: 'l.textContent = "Open in new split"',
  feed: 'toggle("feed"',
  mail: 'toggle("mail"',
  bell: 'toggle("bell"',
...
test("section 2, where it belongs: Tags, Move to folder…, Open in new split", () => {
